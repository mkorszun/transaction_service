...
public class TransactionServiceTest {
    ...
    @org.junit.Test
    public void shouldReturnListOfIdsForSpecificType() throws Exception {
    ...
    @org.junit.Test
    public void shouldReturnExistingTransaction() throws Exception {
        TransactionService service = new TransactionService();
        service.put(4, new Transaction(13, "type2"));
    ...
    @org.junit.Test
    public void shouldReturnNullForNonExistingTransactionId() throws Exception {
        TransactionService service = new TransactionService();
    ...
    public void shouldReturnTransactionSumLinkedToParentTransaction() throws Exception {
        ...
        assertEquals(39.0, service.getChildSum(1));
